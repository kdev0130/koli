    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl shadow-lg bg-card border border-border group-hover/pin:border-primary/30 transition duration-700 overflow-hidden"
        >
      ...
      <div className="w-full h-full -mt-7 flex-none inset-0">
        <div className="absolute top-0 inset-x-0 flex justify-center">
          <a
            ...
            className="relative flex space-x-2 items-center z-10 rounded-full bg-card py-0.5 px-4 ring-1 ring-border"
          >
            <span className="relative z-20 text-foreground text-xs font-bold inline-block py-0.5">
              {title}
            </span>
            <span className="absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] bg-gradient-to-r from-transparent via-primary to-transparent transition-opacity duration-500 group-hover/btn:opacity-40" />
          </a>
        </div>
        ...
        >
          <>
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 h-[11.25rem] w-[11.25rem] rounded-[50%] bg-primary/10 shadow-lg"
            />
            <motion.div
              initial={{ opacity: 0, scale: 0, x: "-50%", y: "-50%" }}
              animate={{ opacity: [0, 1, 0.5, 0], scale: 1, z: 0 }}
