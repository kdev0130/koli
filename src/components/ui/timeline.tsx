  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-5xl mb-4 text-foreground font-bold">
          <span className="text-gradient-gold">KOLI</span> Roadmap
        </h2>
        <p className="text-muted-foreground text-sm md:text-base max-w-lg">
          Our journey to build the Kingdom of Love International - a community-driven 
          token ecosystem focused on spreading love and making a positive impact.
        </p>
      </div>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-card border border-border flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-gradient-gold pulse-glow" />
              </div>
